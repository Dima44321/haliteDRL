...
# TODO
def augment_ship(board, ship):
    """Takes in ship and board and augments board so that ship is in center"""
    return aug_board


# TODO
def augment_sy(board, sy):
    """Takes in shipyard and board and augments board so that shipyard is in center"""
    return aug_board
